...
const styles = StyleSheet.create({
  ...
  cameraHint: { color: '#fff', fontWeight: '800', textAlign: 'center', backgroundColor: 'rgba(0,0,0,0.52)', borderRadius: 18, paddingHorizontal: 16, paddingVertical: 12, overflow: 'hidden' },
  ...
  preview: { width: '100%', height: 200, borderRadius: 22, backgroundColor: '#ddd' },
  ...
  nameInput: { flex: 1, color: colors.text, fontSize: 16, fontWeight: '900', borderBottomWidth: 1, borderBottomColor: colors.border, paddingVertical: 6 },
  ...
  qtyInput: { borderWidth: 1, borderColor: colors.border, borderRadius: 14, paddingHorizontal: 13, paddingVertical: 11, color: colors.text, backgroundColor: colors.surface },
  storageRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  storage: { borderWidth: 1, borderColor: colors.border, borderRadius: 999, paddingHorizontal: 11, paddingVertical: 8, backgroundColor: colors.surface },
  storageActive: { backgroundColor: colors.greenDark, borderColor: colors.greenDark },
  storageText: { color: colors.text, fontSize: 11, fontWeight: '700' },
  storageTextActive: { color: '#fff' },
  manualCard: { gap: 10, backgroundColor: colors.surfaceGreen, borderColor: colors.borderStrong },
  section: { color: colors.text, fontSize: 17, fontWeight: '900' },
  manualRow: { flexDirection: 'row', gap: 8 },
  manualInput: { flex: 1, borderWidth: 1, borderColor: colors.border, borderRadius: 14, paddingHorizontal: 13, paddingVertical: 11, color: colors.text, backgroundColor: colors.card },
  addButton: { backgroundColor: colors.greenDark, borderRadius: 14, paddingHorizontal: 16, justifyContent: 'center' },
