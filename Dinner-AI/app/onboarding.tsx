...
const STEPS = [
  {
    eyebrow: 'InDinecision',
    emoji: '🍽️',
    title: 'We pick. You cook.',
    body: 'Let your ingredients choose for you. InDinecision turns what is already in your kitchen into practical meal ideas, shopping help, and step-by-step cooking guidance.'
  },
  {
  ...
  },
  {
    ...
    body: 'Your Kitchen, favorites, preferences, and recipe history stay on this device. Fridge photos are sent to the InDinecision service and its AI provider only when you choose to scan them. AI can make mistakes—always verify serious allergies, labels, temperatures, and food safety.'
  }
];
  ...
  return (
    <SafeAreaView style={styles.screen}>
      ...
      <View style={styles.hero}>
        {index === 0 ? (
          <Image source={require('../assets/indinecision-logo.png')} style={styles.logo} resizeMode="contain" />
        ) : (
...
const styles = StyleSheet.create({
  ...
  logo: { width: 205, height: 205, marginBottom: 10, alignSelf: 'center' },
