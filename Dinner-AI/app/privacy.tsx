...
export default function PrivacyScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <Text style={styles.title}>How Dinner AI handles your test data</Text>
      <Text style={styles.lead}>Dinner AI v{version} is an early private beta. The goal is to collect enough information to find bugs and improve the experience without collecting unnecessary personal information.</Text>
      ...
      <Section title="When you scan your fridge">
        The photo is sent to the Dinner AI backend and an AI service so visible ingredients can be identified. Dinner AI does not intentionally save the photo in its own app database. Service providers may process data under their own service terms. Only use the scan when you are comfortable sending the image for analysis.
      </Section>

      <Section title="Beta diagnostics">
        Dinner AI may send limited technical events such as app version, platform, feature used, error message, and screen name. These events are intended to help identify crashes, failed scans, timeouts, and confusing workflows. Pantry contents and fridge images are not included in routine beta analytics.
      </Section>
      ...
      <Section title="Food safety and allergies">
        AI detections and recipes can be wrong. Dinner AI is not a medical or allergy-safety service. For serious allergies, verify every ingredient label, cross-contact risk, internal temperature, storage condition, and food-safety decision yourself.
      </Section>
