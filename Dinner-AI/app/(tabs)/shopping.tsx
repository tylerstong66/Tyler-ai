...
const styles = StyleSheet.create({
  content: { padding: 18, gap: 12, backgroundColor: colors.bg, paddingBottom: 40 },
  heading: { color: colors.text, fontSize: 29, fontWeight: '900' },
  sub: { color: colors.muted, lineHeight: 21, marginTop: 5 },
  addCard: { gap: 10 },
  input: { borderWidth: 1, borderColor: colors.border, backgroundColor: '#fff', color: colors.text, borderRadius: 12, paddingHorizontal: 13, paddingVertical: 12, fontSize: 16 },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 6 },
  sectionTitle: { color: colors.text, fontSize: 20, fontWeight: '900' },
  count: { color: colors.green, fontWeight: '900' },
  empty: { color: colors.muted, lineHeight: 21, textAlign: 'center' },
  itemCard: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 12 },
  itemMain: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 11 },
  checkbox: { width: 26, height: 26, borderRadius: 8, borderWidth: 2, borderColor: colors.green, alignItems: 'center', justifyContent: 'center' },
