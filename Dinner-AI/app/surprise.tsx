...
const styles = StyleSheet.create({
  ...
  kicker: { color: colors.green, fontSize: 11, fontWeight: '900', letterSpacing: 1.6 },
  heading: { color: colors.text, fontSize: 20, lineHeight: 25, fontWeight: '900', letterSpacing: -0.2 },
  rowWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  choice: { borderWidth: 1, borderColor: colors.border, borderRadius: 999, paddingHorizontal: 15, paddingVertical: 10, backgroundColor: colors.card },
  choiceActive: { backgroundColor: colors.greenDark, borderColor: colors.greenDark },
  choiceText: { color: colors.text, fontWeight: '800' },
  choiceTextActive: { color: '#fff' },
  timeRow: { flexDirection: 'row', gap: 8 },
  time: { flex: 1, alignItems: 'center', borderWidth: 1, borderColor: colors.border, borderRadius: 16, paddingVertical: 13, backgroundColor: colors.card },
  ...
  description: { color: colors.muted, lineHeight: 23, fontSize: 15.5 },
  ...
  number: { width: 28, height: 28, borderRadius: 14, backgroundColor: colors.greenSoft, color: colors.greenDark, textAlign: 'center', paddingTop: 4, fontWeight: '900' },
